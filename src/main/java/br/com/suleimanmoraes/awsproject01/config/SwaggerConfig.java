...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	public Docket greetingApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).enable(apiProperty.getSwagger().isShow()).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.suleimanmoraes.awsproject01.api.controller"))
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("aws-project-server Spring Boot REST API")
				.description("\"Web Service do aws-project-server\"").version("1.0.0")
