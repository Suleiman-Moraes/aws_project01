...
public class TestController {
	...
	public ResponseEntity<?> dogColor() {
		LOG.info("Test Controller - name: {}", "dogColor");
		return ResponseEntity.ok("Name: dogColor");
	}
	
	@GetMapping("/dog/color2")
	public ResponseEntity<?> dogColor2() {
		LOG.info("Test Controller - name: {}", "dogColor2");
		return ResponseEntity.ok("Name: dogColor2");
	}
}